<?php /* Template Name:Testimonials Template */ 
	...
	query_posts(array( 
		'post_type' => 'testimonials', // only blog testimonials pages
		'showposts' => 16,
		'paged' => $paged
	));
?>
...
?>
<div id="blog-testimonials-list" class="animatedParent animateOnce"  data-sequence="250" data-appear-top-offset="-50">
					...
					<article id="list-item-<?php echo $nr; ?> wow slideInUp" data-wow-duration="1s" data-wow-offset="200">
						<div class="article-bl-content">
							<a class="view-article" href="<?php the_permalink(); ?>">
								<div class="testimonials-item"><?php the_post_thumbnail(array(380,254)); ?></div>
							</a>
							<h2><?php the_title(); ?></h2>
