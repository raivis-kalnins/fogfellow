...
function create_post_type_products() {
    ...
    register_post_type('products', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Products', 'dp'), // Rename these to suit
            'singular_name' => __('products', 'dp'),
            'add_new' => __('Add New', 'dp'),
            'add_new_item' => __('Add New products Post', 'dp'),
            'edit' => __('Edit', 'dp'),
            'edit_item' => __('Edit products Post', 'dp'),
            'new_item' => __('New products Post', 'dp'),
            'view' => __('View products Post', 'dp'),
            'view_item' => __('View products Post', 'dp'),
            'search_items' => __('Search products Post', 'dp'),
            'not_found' => __('No products Posts found', 'dp'),
            'not_found_in_trash' => __('No products Posts found in Trash', 'dp')
        ),
        'public' => true,
        'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => true,
...
add_action('init', 'create_post_type_products'); // Add our finance Blank Custom Post Type
